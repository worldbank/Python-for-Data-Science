# Why You Need Python Environments and How To Manage Them [click here for version with screenshots](https://github.com/worldbank/Python-for-Data-Science/blob/master/anaconda_virtual_environments.md) 
